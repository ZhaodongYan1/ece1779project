...
def update_user_statistics(user, requestType, size):
    ...
    try:
        ...
        item = {"requestID": user, "translation_req": 0, "translation_size": 0, "textract_req": 0, "textract_size": 0, \
                "sentiment_req": 0, "sentiment_size": 0, "grammar_req": 0, "grammar_size": 0, }
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        info = object_key.split('/')
        author, requestType,filename = info[0],info[1],info[2]
